...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    throwNoSuchMethod: function(obj, $name, $arguments, expectedArgumentNames) {
      throw H.wrapException(new P.NoSuchMethodError(obj, new H.Symbol($name), $arguments, H.JsLinkedHashMap_JsLinkedHashMap$es6(), expectedArgumentNames));
    },
    ...
    JsLinkedHashMap: {
      ...
      static: {
        JsLinkedHashMap_JsLinkedHashMap$es6: function() {
    ...
    NoSuchMethodError: {
      ...
      toString$0: function(_) {
        ...
        t2 = this._arguments;
        if (t2 != null)
          for (t2 = J.get$iterator$a(t2); t2.moveNext$0();) {
        ...
        if (t1 == null)
          ...
          formalParameters = J.join$1$a(t1, ", ");
    ...
    onDataLoaded: [function(responseText) {
      var line = H.S(responseText);
      H.printString(line);
    }, "call$1", "main__onDataLoaded$closure", 2, 0, 0],
    main: function() {
      H.throwNoSuchMethod("", "HttpRequest", [], null).getString$1("http://eve-marketdata.com/api/item_orders2.json?char_name=demo&buysell=b&type_ids=34,36").then$1(F.main__onDataLoaded$closure());
    }
  }, 1]];
  setupProgram(dart, 0);
  ...
  $ = new Isolate();
  init.metadata = [];
  init.types = [{func: 1, v: true, args: [P.String]}];
